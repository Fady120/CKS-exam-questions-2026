...
echo ""
echo "CONTEXT:"
echo "  A namespace 'secure' exists and a TLS certificate/key pair has been"
echo "  generated for you at /root/certs/tls.crt and /root/certs/tls.key."
echo "  A deployment manifest is available at /root/secure-deploy.yaml."
echo ""
echo "TASK:"
echo "  1. Create a TLS secret named 'app-tls' in the namespace 'secure'"
...
echo ""
echo "HINTS:"
echo "  - kubectl create secret tls app-tls --cert=<cert> --key=<key> -n secure"
